...
def get_license_type_from_fandom_url(a_tag: Any) -> str:
    """
    Extracts the license type from a given HTML anchor tag of a fandom webpage.

    Args:
        a_tag (Any): An HTML anchor tag object containing the license type text.

    Returns:
        str: The license type extracted from the anchor tag's text.
    """
    return a_tag.text
